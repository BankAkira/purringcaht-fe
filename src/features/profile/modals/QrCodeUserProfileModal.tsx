...
export default function QrCodeUserProfileModal({
  openModal,
  onCloseModal,
  profile,
}: Props) {
      ...
      <Modal show={openModal} onClose={onCloseModal} size="lg">
        <Modal.Body>
          <div className="flex flex-col items-center">
            <p className="p-4 text-[25px] font-bold">QR-Code</p>
            ...
            <Button
              ...
              className={
                ...
                ' ms-auto bg-gradient-to-br from-pink-500 to-orange-400 !border-0 min-w-0 lg:min-w-[124px] h-[34px] max-lg:max-h-[28px] max-lg:bg-transparent transition bg-white text-white m-2 p-5'
              }
